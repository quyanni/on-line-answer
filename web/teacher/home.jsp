...
<body>
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-3">
				<div class="list-group">
					<a href="${ pageContext.request.contextPath }/TeacherServlet?method=difficultiesAnswer" class="list-group-item active">难点答疑</a>
					<c:forEach var="message" items="${ difficulties }">
						<a href="TeacherServlet?method=showDifficulties&mid=${message.mid}" class="list-group-item">${ message.title }</a>
					</c:forEach>
				</div>
			</div>
			<div class="col-md-3">
