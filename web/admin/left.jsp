...
<div style="margin-top: 10px; margin-left: 20px;">
	<div class="dtree">
		...
		<script type="text/javascript">   
			...
			d.add('0107','01','学生管理');
			d.add('010701','0107','学生列表','${pageContext.request.contextPath}/AdminServlet?method=showStudentList','提示信息','mainFrame');
			d.add('010702','0107','导入学生','${pageContext.request.contextPath}/admin/addStudent.jsp','提示信息','mainFrame');
